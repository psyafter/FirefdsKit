...
public class Preferences {
    ...
    public static final String PREF_SKIP_TRACKS_WITH_VOLUME_KEYS = "skipTracksWithVolumeKeys";
    ...
    public static final String PREF_ENABLE_DUAL_SIM_SD_CARD = "enableDualSimSdCard";
