 ...
 */
package sb.firefds.v.firefdskit.rebootactions;

import static sb.firefds.v.firefdskit.utils.Constants.DOWNLOAD_ACTION;
import static sb.firefds.v.firefdskit.utils.Constants.QUICK_REBOOT_DEVICE_ACTION;
import static sb.firefds.v.firefdskit.utils.Constants.REBOOT_DEVICE_ACTION;
...
public class RebootActionFactory {
    ...
    public static Optional<RebootAction> getRebootAction(String rebootAction) {
        return Optional.ofNullable(REBOOT_ACTION_MAP.get(rebootAction)).map(Supplier::get);
    }
}
