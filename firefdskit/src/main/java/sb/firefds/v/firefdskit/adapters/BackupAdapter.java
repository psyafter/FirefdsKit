 ...
 */
package sb.firefds.v.firefdskit.adapters;
...
public class BackupAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            ((TextView) convertView.findViewById(android.R.id.text1)).setText(backups[position].getName()
                                                                                               .replace(".fk", ""));
            ((TextView) convertView.findViewById(android.R.id.text2)).setText(new Date(backups[position].lastModified()).toString());
        }
        return convertView;
    }
